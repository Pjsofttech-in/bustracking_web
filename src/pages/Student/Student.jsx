// Student.jsx - Fully Responsive for All iPhone Models
...
export default function Student() {
  ...
  const loadDropdowns = async () => {
    try {
      const [classesData, divisionsData, mediumsData, academicYearsData] = await Promise.all([
        ...
        api.divisions.getAll().catch(() => []),
        api.mediums.getAll().catch(() => []),
        api.academicYears.getAll().catch(() => [])
      ]);
  ...
  const handleRowClick = async (row) => {
    try {
      const studentData = await api.students.getById(row.id);
      setForm({
        ...studentData,
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (selectedId) {
        const updatedStudent = await api.students.update(selectedId, payload);
        setStudents(students.map(s => s.id === selectedId ? updatedStudent : s));
        showSnackbar("Student updated successfully!", "success");
      } else {
        const newStudent = await api.students.create(payload);
  ...
  const handleConfirmDelete = async () => {
    setSubmitting(true);
    try {
      await api.students.delete(selectedId);
          ...
          <Box sx={{ 
            ...
            <StatsCard>
              ...
              <Typography variant="h6" sx={{ fontWeight: 700, fontSize: { xs: "0.85rem", sm: "1rem", md: "1.25rem" }, color: "#d97706" }}>
                {students.filter(s => s.inBus).length}
              </Typography>
            </StatsCard>
          </Box>
            ...
            {isDesktop ? (
              ...
              <StyledTableContainer>
                <Table stickyHeader size={isExtraSmall ? "small" : "medium"}>
                  <GradientHeader>
                    <TableRow>
                      <TableCell sx={{ minWidth: { xs: "25px", sm: "30px", md: "40px" } }}>
                        <Typography variant="caption" sx={{ fontWeight: 700, fontSize: { xs: "0.4rem", sm: "0.5rem", md: "0.6rem" } }}>
                          ID
                        </Typography>
                      </TableCell>
                      ...
                      <TableCell sx={{ minWidth: { xs: "60px", sm: "70px", md: "90px" } }}>
                        <Typography variant="caption" sx={{ fontWeight: 700, fontSize: { xs: "0.4rem", sm: "0.5rem", md: "0.6rem" } }}>
                          Admission
                        </Typography>
                      </TableCell>
                      ...
                      <TableCell sx={{ minWidth: { xs: "50px", sm: "60px", md: "80px" } }} align="center">
                        <Typography variant="caption" sx={{ fontWeight: 700, fontSize: { xs: "0.4rem", sm: "0.5rem", md: "0.6rem" } }}>
                          Status
                        </Typography>
                      </TableCell>
                      <TableCell sx={{ minWidth: { xs: "40px", sm: "50px", md: "60px" } }} align="center">
                        <Typography variant="caption" sx={{ fontWeight: 700, fontSize: { xs: "0.4rem", sm: "0.5rem", md: "0.6rem" } }}>
                          Present
                        </Typography>
                      </TableCell>
                    ...
                    {students.length > 0 ? (
                      students.map((s) => (
                        <StyledTableRow key={s.id} onClick={() => handleRowClick(s)}>
                          ...
                          <TableCell sx={{ fontSize: { xs: '0.45rem', sm: '0.55rem', md: '0.7rem' } }}>
                            {s.rollNumber}
                          </TableCell>
                          <TableCell sx={{ fontSize: { xs: '0.45rem', sm: '0.55rem', md: '0.7rem' } }}>
                            {formatDate(s.admission)}
                          </TableCell>
                          <TableCell sx={{ fontSize: { xs: '0.45rem', sm: '0.55rem', md: '0.7rem' }, wordBreak: 'break-word' }}>
                            {s.parentName}
                          </TableCell>
                          <TableCell sx={{ fontSize: { xs: '0.45rem', sm: '0.55rem', md: '0.7rem' } }}>
                            {s.parentPhone}
                          ...
                          <TableCell align="center">
                            <Chip 
                              ...
                              size="small"
                              sx={{
                                backgroundColor: getStatusColor(s.status).bg,
                                color: getStatusColor(s.status).color,
                                fontWeight: 600,
                                fontSize: { xs: "0.4rem", sm: "0.5rem", md: "0.6rem" },
                                borderRadius: "6px",
                                height: { xs: "14px", sm: "16px", md: "20px" },
                                minWidth: { xs: "35px", sm: "45px", md: "55px" }
                              }}
                            />
                          </TableCell>
                          <TableCell align="center">
                            <Chip 
                              label={s.present ? "Yes" : "No"}
                              size="small"
                              sx={{
                          ...
                          <TableCell align="center">
                            <Chip 
                              label={s.inBus ? "Yes" : "No"}
                              size="small"
                              sx={{
                                backgroundColor: s.inBus ? "#dbeafe" : "#f1f5f9",
                                color: s.inBus ? "#6495ED" : "#94a3b8",
                                fontWeight: 600,
                                fontSize: { xs: "0.4rem", sm: "0.5rem", md: "0.6rem" },
                                borderRadius: "6px",
                                height: { xs: "14px", sm: "16px", md: "20px" },
                          ...
                          <CardContent sx={{ 
                            ...
                            <Box sx={{ 
                              ...
                              <Box>
                                ...
                                <Typography variant="body2" sx={{ fontWeight: 500, fontSize: { xs: "0.65rem", sm: "0.75rem", md: "0.8rem" } }}>
                                  <ClassIcon sx={{ fontSize: { xs: 12, sm: 14 }, color: "#64748b", mr: 0.5 }} />
                                  {s.studentClass}
                                </Typography>
                              </Box>
                              <Box>
                                ...
                                <Typography variant="body2" sx={{ fontWeight: 500, fontSize: { xs: "0.65rem", sm: "0.75rem", md: "0.8rem" } }}>
                                  <GroupsIcon sx={{ fontSize: { xs: 12, sm: 14 }, color: "#64748b", mr: 0.5 }} />
                                  {s.division}
                                </Typography>
                              </Box>
                              <Box>
                                ...
                                <Typography variant="body2" sx={{ fontWeight: 500, fontSize: { xs: "0.65rem", sm: "0.75rem", md: "0.8rem" } }}>
                                  <LanguageIcon sx={{ fontSize: { xs: 12, sm: 14 }, color: "#64748b", mr: 0.5 }} />
                                  {s.medium}
                                </Typography>
                              </Box>
                              <Box>
                                ...
                                <Typography variant="body2" sx={{ fontWeight: 500, fontSize: { xs: "0.65rem", sm: "0.75rem", md: "0.8rem" } }}>
                                  <CalendarMonthIcon sx={{ fontSize: { xs: 12, sm: 14 }, color: "#64748b", mr: 0.5 }} />
                                  {s.academicYear}
                                </Typography>
                              </Box>
                              <Box>
                                ...
                                <Typography variant="body2" sx={{ fontWeight: 500, fontSize: { xs: "0.65rem", sm: "0.75rem", md: "0.8rem" } }}>
                                  Present: {s.present ? "✅" : "❌"} | In Bus: {s.inBus ? "✅" : "❌"}
                                </Typography>
                              </Box>
                            </Box>
        ...
        <DialogTitle sx={{ 
          ...
          <Box sx={{ display: 'flex', gap: 0.5 }}>
            {selectedId && (
              <>
                <Tooltip title="Edit">
                  <IconButton onClick={() => setIsEdit(true)} size={isExtraSmall ? "small" : "medium"} disabled={submitting}>
            ...
            <Grid item xs={12} sm={6} md={4}>
              <Box sx={{ 
                ...
                <FormControlLabel
                  ...
                  label={<Typography sx={{ fontSize: { xs: '0.75rem', sm: '0.85rem' } }}>Present</Typography>}
                />
                <FormControlLabel
                  control={
                    <Switch
                      checked={form.inBus || false}
                      onChange={handleChange}
                      name="inBus"
                      disabled={!isEdit || submitting}
                      size={isExtraSmall ? "small" : "medium"}
                  ...
                  label={<Typography sx={{ fontSize: { xs: '0.75rem', sm: '0.85rem' } }}>In Bus</Typography>}
                />
              </Box>
            </Grid>
          </Grid>
