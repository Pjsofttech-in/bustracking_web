// DriverSignUp.jsx - Fully Responsive for All iPhone Models
...
function DriverSignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const requiredFields = ['name', 'phone', 'employeeId', 'licenseNumber', 'licenseExpiryDate', 'joiningDate'];
      ...
      if (formData.status === 'Terminated' && !formData.terminatedDate) {
      ...
      const driverData = {
        ...
        terminatedDate: formData.terminatedDate || null,
      ...
      // Send to API
      const response = await api.drivers.create(driverData);
      ...
      setError(err.message || 'Failed to register driver. Please try again.');
    } finally {
      setLoading(false);
    }
  };
        ...
        <ContentWrapper>
          ...
          <Box sx={{
            ...
            <Box sx={{ minWidth: 0 }}>
              ...
              >
                Register a new driver in the bus tracking system
              </Typography>
            </Box>
            ...
            >
              <span className="hidden xs:inline">Back to Drivers</span>
                  ...
                  <Grid item xs={12} sm={6}>
                    <StyledTextField
                      ...
                      InputProps={{
                        startAdornment: (
                          <InputAdornment position="start">
                            <DriveEtaIcon sx={{ color: '#94a3b8', fontSize: isExtraSmall ? 16 : 20 }} />
                          </InputAdornment>
                        )
                      }}
